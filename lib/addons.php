		...
		function __construct(){
			$this->addons = array(
				'acf-tax' => array(
					...
					'file' => 'acf-tax.php',
					'init' => 'Tax_field',
					'title' => __('Taxonomy Checkboxes','acf-addons'),
				...
				'acf-paypal' => array(
					...
					'title' => __('Paypal Item','acf-addons'),
				...
				'acf-flickr' => array(
					...
					'file' => 'flickr.php',
					'init' => 'Flickr_field',
					'title' => __('Flickr Dropdown','acf-addons'),
				...
				'acf-user-select' => array(
					...
					'init' => 'Users_field',
					'title' => __('Users Select','acf-addons'),
				...
				'acf-categories' => array(
					...
					'title' => __('Categories','acf-addons'),
				...
				'acf-unique-key' => array(
					...
					'title' => __('Unique Key','acf-addons'),
					'more_link' => 'https://github.com/cubeweb/acf-addons',
				...
				'acf-time-picker' => array(
					...
					'title' => __('Date & Time Picker','acf-addons'),
				...
				'acf-advanced-numfield' => array(
					...
					'init' => 'Num_field',
					'title' => __('Advanced Number','acf-addons'),
